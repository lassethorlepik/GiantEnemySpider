...
local leg_lower_part_graphics_definitions =
{
  ...
  top_end =
  {
    filename = "__GiantEnemySpider__/graphics/spider/legs/spidertron-legs-lower-end-A.png",
    width = 20,
    height = 50,
    variation_count = 8,
  ...
  middle =
  {
    filename = "__GiantEnemySpider__/graphics/spider/legs/spidertron-legs-lower-stretchable.png",
    width = 26,
    height = 192,
    variation_count = 8,
    scale = 0.5,
  ...
  bottom_end =
  {
    filename = "__GiantEnemySpider__/graphics/spider/legs/spidertron-legs-lower-end-B.png",
    width = 18,
    height = 46,
    variation_count = 8,
...
local leg_upper_part_graphics_definitions =
{
  ...
  top_end =
  {
    filename = "__GiantEnemySpider__/graphics/spider/legs/spidertron-legs-upper-end-A.png",
    width = 22,
    height = 44,
    variation_count = 8,
  ...
  middle =
  {
    filename = "__GiantEnemySpider__/graphics/spider/legs/spidertron-legs-upper-stretchable.png",
    width = 30,
    height = 128,
    variation_count = 8,
    scale = 0.5,
  ...
  bottom_end =
  {
    filename = "__GiantEnemySpider__/graphics/spider/legs/spidertron-legs-upper-end-B.png",
    width = 20,
    height = 30,
    variation_count = 8,
...
{
  filename = "__GiantEnemySpider__/graphics/spider/legs/spidertron-legs-knee.png",
  width = 12,
  height = 14,
  variation_count = 8,
  shift = util.by_pixel(1, 0),
    ...
    {
      {
        ...
        hr_version =
        {
          filename = "__GiantEnemySpider__/graphics/spider/torso/hr-spidertron-body.png",
          width = 132,
          height = 138,
          line_length = 8,
          direction_count = 64,
      ...
      {
        filename = "__GiantEnemySpider__/graphics/spider/torso/spidertron-body-mask.png",
        width = 66,
        height = 50,
        line_length = 8,
        direction_count = 64,
        ...
        hr_version =
        {
          filename = "__GiantEnemySpider__/graphics/spider/torso/hr-spidertron-body-mask.png",
          width = 130,
          height = 100,
          line_length = 8,
          direction_count = 64,
